...
{
    /// <summary>
    /// Controller that redirects lightning strike requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/Lightning")]
    [RoutePrefix("api/EventWidgets/Lightning")]
    public class LightningController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
