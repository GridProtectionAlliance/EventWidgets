...
{
    /// <summary>
    /// Controller that redirects time-correlated sag requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/CorrelatedSags")]
    [RoutePrefix("api/EventWidgets/CorrelatedSags")]
    public class CorrelatedSagsController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public CorrelatedSagsController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif
