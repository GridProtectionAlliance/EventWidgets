...
{
    /// <summary>
    /// Controller that redirects breaker performance requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/BreakerPerformance")]
    [RoutePrefix("api/EventWidgets/BreakerPerformance")]
    public class BreakerPerformanceController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public BreakerPerformanceController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif
