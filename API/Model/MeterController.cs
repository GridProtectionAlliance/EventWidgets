...
namespace Widgets.API.Model
{
    ...
    /// model.
    /// </summary>
    [XDARedirect("api/Widgets/DetailedMeter")]
    [RoutePrefix("api/EventWidgets/Meter")]
    public class MeterController : RedirectionController
    {
        #if IS_GEMSTONE
        /// <summary>
        ...
        public MeterController(IAPICredentialRetriever retriever) : base(retriever) { }
        #endif
