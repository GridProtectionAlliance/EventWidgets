...
{
    /// <summary>
    /// Controller that redirects ITOA interruption requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/ITOA")]
    [RoutePrefix("api/EventWidgets/ITOA")]
    public class ITOAController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public ITOAController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif
