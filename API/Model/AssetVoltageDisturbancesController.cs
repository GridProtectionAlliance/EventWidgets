...
{
    /// <summary>
    /// Controller that redirects voltage disturbance requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/AssetVoltageDisturbances")]
    [RoutePrefix("api/EventWidgets/AssetVoltageDisturbances")]
    public class AssetVoltageDisturbancesController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public AssetVoltageDisturbancesController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif

        [Route("{EventID:int}"), HttpGet]
        public async ServerResponse GetAssetVoltageDisturbances(int EventID, CancellationToken token) =>
