...
{
    /// <summary>
    /// Controller that redirects line parameter requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/LineParameter")]
    [RoutePrefix("api/EventWidgets/LineParameter")]
    public class LineParameterController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public LineParameterController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif

        [Route("{eventID:int}"), HttpGet]
        public async ServerResponse GetLineParameters(int eventID, CancellationToken token) =>
