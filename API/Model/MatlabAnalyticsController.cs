...
{
    /// <summary>
    /// Controller that redirects MATLAB analytic result requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/MatlabAnalytics")]
    [RoutePrefix("api/EventWidgets/MatlabAnalytics")]
    public class MatlabAnalyticsController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public MatlabAnalyticsController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif

        [Route("{eventID:int}"), HttpGet]
        public async ServerResponse GetMatlabAnalytics(int eventID, CancellationToken token) =>
