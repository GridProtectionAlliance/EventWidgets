...
{
    /// <summary>
    /// Controller that redirects relay performance requests to XDA.
    /// </summary>
    [XDARedirect("api/Widgets/RelayPerformance")]
    [RoutePrefix("api/EventWidgets/RelayPerformance")]
    public class RelayPerformanceController : RedirectionController
    {
#if IS_GEMSTONE
        /// <summary>
        ...
        public RelayPerformanceController(IAPICredentialRetriever retriever) : base(retriever) { }
#endif
