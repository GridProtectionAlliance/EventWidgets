...
const AllWidgets: EventWidget.IWidget<any>[] = [
    LineParameters,
    EventSearchOpenSEE,
    ESRIMap,
    FaultInfo,
    EventSearchAssetFaultSegments,
    AssetVoltageDisturbances,
    EventSearchCorrelatedSags,
    SOE,
    EventSearchPQI,
    Lightning,
    EventSearchFileInfo,
    ...
    PQICurve,
    InterruptionReport,
    EventSearchRelayPerformance,
    EventSearchBreakerPerformance,
    EventSearchCapBankAnalyticOverview,
    AssetHistoryStats,
    AssetHistoryTable,
    MatlabAnalyticResults,
    EventInfo,
    ITOA,
    TrendGraph,
    PQAI
...
const WidgetRouter = (props: IProps) => {
